...
class TehtavatMuuliDataSource extends CalendarDataSource<Tehtava> {
  TehtavatMuuliDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatMuuliDataSource haCalendarDataSource() {
  ...
  final Tehtava recurrenceApp = Tehtava(
    ...
    isAllDay: !false,
    background: const Color.fromARGB(255, 234, 0, 255),
    recurrenceRule: 'FREQ=WEEKLY;BYDAY=MO;COUNT=20',
  );

  appointments.add(recurrenceApp);

  return TehtavatMuuliDataSource(appointments);
}
