...
class TehtavatKultaDataSource extends CalendarDataSource<Tehtava> {
  TehtavatKultaDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatKultaDataSource haetCalendarDataSource() {
  ...
  final Tehtava recurrenceApp = Tehtava(
    ...
    isAllDay: !false,
    background: const Color.fromARGB(255, 165, 152, 0),
    recurrenceRule: 'FREQ=WEEKLY;BYDAY=MO;COUNT=20',
  );

  appointments.add(recurrenceApp);

  return TehtavatKultaDataSource(appointments);
}
