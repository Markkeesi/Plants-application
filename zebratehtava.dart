...
class TehtavatZebraDataSource extends CalendarDataSource<Tehtava> {
  TehtavatZebraDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatZebraDataSource gettCalendarDataSource() {
  ...
  final Tehtava recurrenceApp = Tehtava(
    ...
    isAllDay: !false,
    background: const Color.fromARGB(255, 9, 174, 0),
    recurrenceRule: 'FREQ=WEEKLY;BYDAY=WE;COUNT=20',
  );

  appointments.add(recurrenceApp);

  return TehtavatZebraDataSource(appointments);
}
