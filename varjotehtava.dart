...
class TehtavatVarjoDataSource extends CalendarDataSource<Tehtava> {
  TehtavatVarjoDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatVarjoDataSource haeCalendarDataSource() {
  ...
  return TehtavatVarjoDataSource(appointments);
}
