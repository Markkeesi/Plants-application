...
class TehtavatPulloDataSource extends CalendarDataSource<Tehtava> {
  TehtavatPulloDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatPulloDataSource heatCalendarDataSource() {
  ...
  final Tehtava recurrenceApp = Tehtava(
    ...
    isAllDay: !false,
    background: const Color.fromARGB(255, 0, 255, 217),
    recurrenceRule: 'FREQ=WEEKLY;BYDAY=MO;COUNT=20',
  );

  appointments.add(recurrenceApp);

  return TehtavatPulloDataSource(appointments);
}
