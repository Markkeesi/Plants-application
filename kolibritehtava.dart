...
class TehtavatKolibriDataSource extends CalendarDataSource<Tehtava> {
  TehtavatKolibriDataSource(List<Tehtava> source) {
    appointments = source;
  }
...
TehtavatKolibriDataSource gettoCalendarDataSource() {
  ...
  return TehtavatKolibriDataSource(appointments);
}
